...
const I = {
  ...
  discord: <path d="M20.3 4.6A19.8 19.8 0 0 0 15.9 3l-.7 1.4a18.4 18.4 0 0 0-6.4 0L8.1 3A19.8 19.8 0 0 0 3.7 4.6 20.3 20.3 0 0 0 .3 19.1a19.7 19.7 0 0 0 6 3l1.6-2.6a12.9 12.9 0 0 1-2-1l.5-.4a13.8 13.8 0 0 0 11.2 0l.5.4a13 13 0 0 1-2 1l1.6 2.6a19.7 19.7 0 0 0 6-3A20.2 20.2 0 0 0 20.3 4.6ZM8.7 16.1c-1.2 0-2.2-1.1-2.2-2.4s1-2.4 2.2-2.4 2.3 1.1 2.2 2.4-1 2.4-2.2 2.4Zm6.6 0c-1.2 0-2.2-1.1-2.2-2.4s1-2.4 2.2-2.4 2.3 1.1 2.2 2.4-1 2.4-2.2 2.4Z" />,
  youtube: <><path fill="#FF0000" stroke="none" d="M23 7s-.2-1.6-.9-2.3c-.9-.9-1.9-.9-2.3-1C16.4 3.4 12 3.4 12 3.4s-4.4 0-7.8.2c-.4.1-1.4.2-2.3 1C1.2 5.4 1 7 1 7S.8 8.8.8 10.7v1.6C.8 14.2 1 16 1 16s.2 1.6.9 2.3c.9.9 2.1.9 2.6 1 1.9.2 7.5.2 7.5.2s4.4 0 7.8-.2c.4-.1 1.4-.2 2.3-1 .7-.7.9-2.3.9-2.3s.2-1.8.2-3.7v-1.6C23.2 8.8 23 7 23 7ZM9.5 15.6V8.4l6.4 3.6-6.4 3.6Z" /></>,
  reddit: <path d="M14 2h3l-2 3s.5 0 .5.5a5.4 5.4 0 0 1 5 3.8 2.3 2.3 0 0 1 1.5 2.8 2.3 2.3 0 0 1-2 1.7c-.2.1-.5.2-.9.3a4 4 0 0 1 .5 1.9c0 2.5-2.9 4.4-6.6 4.4s-6.6-1.9-6.6-4.4c0-.7.2-1.4.5-1.9l-.7-.3A2.3 2.3 0 0 1 2 9.2 2.3 2.3 0 0 1 3.6 6.3a5.4 5.4 0 0 1 5-3.7l3-5.9V1h3v.1Zm-6.4 9a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4Zm8.8 0a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4Zm-7.7 5.2a4.7 4.7 0 0 0 6.6 0l-1-1.9a3.4 3.4 0 0 1-4.6 0Z" />,
  xbox: <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2Zm0 4 2.3 2.2A5.5 5.5 0 0 1 20 12a5.7 5.7 0 0 1-1.8 4.1l-.6-.5a4.8 4.8 0 0 0-1.6-3.6A4.8 4.8 0 0 0 12 10.2 4.8 4.8 0 0 0 8 12a4.8 4.8 0 0 0-1.6 3.6l-.6.5A5.7 5.7 0 0 1 4 12a5.5 5.5 0 0 1 5.7-5.8Z" />,
  steam: <path d="M12 2a10 10 0 0 0 0 20c1 .1 1.6-.6 1.6-1.4 0-.8-.5-1.3-1.2-1.9l2.6-1.5a3.4 3.4 0 0 0 1.5-.4A5 5 0 0 0 12 4.6l3.9 2.3a3.3 3.3 0 1 1-1.6 3l-3.3 1.9a3.3 3.3 0 1 1-1.2 1.9L8.9 14c2.2 0 4-1.8 4-4a4 4 0 0 0-7.8-1.1A4 4 0 0 0 6 14.3l2.4 1.4a1.2 1.2 0 1 1-1.8 1.5L12 20A10 10 0 0 0 22 12 10 10 0 0 0 12 2Zm-1.9 13.6-1.3-.8c-.8 0-1.6-.4-2.1-1a3.3 3.3 0 1 0 3.4-.1Z" />,
}
